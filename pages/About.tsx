...
const AboutPage: React.FC = () => {
  return (
    <div className="bg-white p-6 sm:p-8 lg:p-12 rounded-xl shadow-md">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-extrabold text-center text-slate-900 mb-6">Our Story</h1>
        <p className="text-lg text-center text-slate-600 mb-12">From the looms of Komarapalayam to your wardrobe.</p>
