...
const AboutPage: React.FC = () => {
  return (
    <div className="bg-white p-6 sm:p-8 lg:p-12 rounded-lg shadow-md">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-extrabold text-center text-dark mb-6">Our Story</h1>
        <p className="text-lg text-center text-gray-600 mb-12">From the looms of Komarapalayam to your wardrobe.</p>
