            ...
            <div className="grid grid-cols-5 gap-2">
              {product.images.map((img, index) => (
                <button
                  ...
                  className={`aspect-w-1 aspect-h-1 rounded-sm overflow-hidden ring-2 transition ${activeImage === index ? 'ring-primary' : 'ring-transparent hover:ring-primary/50'}`}
                >
          ...
          <div className="flex flex-col">
              ...
              <div className="mt-auto pt-8">
                  ...
                  <button 
                      ...
                      className="w-full bg-primary text-white font-bold py-3 px-6 rounded-md hover:bg-secondary transition-colors duration-300"
                  >
                      ADD TO CART
                  </button>
              </div>
