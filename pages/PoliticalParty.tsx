...
const PoliticalPartyPage: React.FC = () => {
  ...
  return (
    <div className="space-y-12">
      <div className="text-center bg-gradient-to-r from-red-50 via-white to-blue-50 p-8 rounded-lg">
      ...
      {politicalProducts.length > 0 ? (
        ...
        <div className="text-center py-16">
          <p className="text-xl text-gray-500">The Political Party collection is currently empty.</p>
