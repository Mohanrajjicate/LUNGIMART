...
const CartPage: React.FC = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="text-center py-20 bg-white">
        ...
        <Link
          to="/shop"
          className="mt-6 inline-block bg-primary text-white font-bold py-3 px-8 rounded-full hover:bg-secondary transition-colors"
        >
          Start Shopping
        </Link>
      </div>
  ...
  return (
    <div className="bg-white p-4 sm:p-6 lg:p-8">
      <h1 className="text-3xl font-bold text-secondary mb-8 text-center">Shopping Cart</h1>
      <div className="lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                ...
                <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                  <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                    <div>
                      ...
                      <p className="mt-1 text-sm font-medium text-secondary">₹{item.price.toFixed(2)}</p>
                    </div>
        ...
        {/* Order summary */}
        <section className="mt-16 rounded-lg bg-light-bg px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8 sticky top-28">
          <h2 className="text-lg font-medium text-secondary">Order summary</h2>
          <dl className="mt-6 space-y-4">
            <div className="flex items-center justify-between">
              <dt className="text-sm text-secondary-light">Subtotal ({cartCount} items)</dt>
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full bg-primary border border-transparent rounded-full shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary transition-colors"
            >
              Proceed to Checkout
            </button>
          </div>
