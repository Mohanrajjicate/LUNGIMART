    ...
    <footer className="bg-white">
      ...
      <div className="bg-primary text-white">
        <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
                <h4 className="font-semibold">Authentic Quality</h4>
                <p className="text-sm text-gray-300 mt-1">Directly from Komarapalayam weavers</p>
            </div>
            <div className="flex flex-col items-center">
                <h4 className="font-semibold">Customer Support</h4>
                <p className="text-sm text-gray-300 mt-1">We are here to help you</p>
            </div>
            <div className="flex flex-col items-center">
      ...
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Category */}
            <div>
                <h5 className="font-bold text-primary mb-4">Shop</h5>
                <ul className="space-y-2 text-sm">
                    <li><Link to="/shop/lungis" className="text-secondary hover:text-primary">Lungis</Link></li>
                    <li><Link to="/shop/dhotis" className="text-secondary hover:text-primary">Dhotis</Link></li>
                    <li><Link to="/shop/cotton" className="text-secondary hover:text-primary">Cotton Wear</Link></li>
                    <li><Link to="/shop/silk-blend" className="text-secondary hover:text-primary">Silk Blends</Link></li>
                </ul>
            </div>
            {/* Company Service */}
            <div>
                <h5 className="font-bold text-primary mb-4">Our Company</h5>
                <ul className="space-y-2 text-sm">
                    <li><Link to="/about" className="text-secondary hover:text-primary">About Us</Link></li>
                    <li><Link to="#" className="text-secondary hover:text-primary">Shipping Information</Link></li>
            ...
            <div className="md:col-span-1">
                 ...
                 <p className="text-sm text-secondary mb-4">Get the latest updates on new products and upcoming sales.</p>
                 <form>
      ...
      <div className="border-t border-light-border">
          <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center text-sm">
             <p className="text-secondary mb-2 sm:mb-0">&copy;{new Date().getFullYear()} LungiMart.in All Rights are reserved</p>
